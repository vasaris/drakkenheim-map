#!/usr/bin/env node
// АРХИВНЫЙ СКРИПТ (Ф5): вход (data/zones.json, data/markers.json — v1) удалён из
// репо декомиссией Ф5 — прод два деплоя живёт на v3, v1-эталон и откат-страховка
// отслужили. Скрипт больше не запускается и не запустится (ENOENT на ZONES_IN/
// MARKERS_IN); оставлен только как документация формулы миграции v1->v2 ниже.
//
